    ...
    select(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const resultSales = yield connect_1.client.query("SELECT *FROM sales WHERE id_sale > '" + id + "'");
                const sales = resultSales.rows;
                response.json(sales);
                console.log("successful search !!");
                console.log(sales);
                /**Consulta Itens da Venda - em teste */
                const resultItensSale = yield connect_1.client.query("SELECT *FROM itens_sale WHERE id_item_sequen > '" + id + "'");
