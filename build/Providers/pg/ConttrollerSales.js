    ...
    insert(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const num_sale = res_num_sale.rows[0].max + 1;
                ...
                yield connect_1.client.query('INSERT INTO sales("fk_name_pers","val_rec", "disc_sale", "total_sale", fk_name_filial, fk_name_user) VALUES ('
                    + "'"
