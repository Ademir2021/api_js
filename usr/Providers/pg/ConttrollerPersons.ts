...
export class ConttrollersPersons {
    ...
    async update(request: Request, response: Response) {
        try {
            ...
            const  person : IPerson = <IPerson>request.body
            await client.query("UPDATE persons SET updated_at =  now(), name_pers = '" + person.name_pers + "', cpf_pers = '" + person.cpf_pers + "', phone_pers ='"+person.phone_pers+"', address_pers ='" + person.address_pers + "', fk_name_filial = '" + person.fk_name_filial + "' WHERE id_person = '" + id + "'")
