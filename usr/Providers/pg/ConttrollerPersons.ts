...
export class ConttrollersPersons {
    ...
    async insert(request: Request, response: Response) {
        try {
            ...
            try {
                ...
                await client.query('INSERT INTO persons("name_pers", "cpf_pers", "address_pers", "fk_name_filial", fk_id_user) VALUES (' + "'" + person.name_pers + "', '" + person.cpf_pers + "', '" + person.address_pers + "', '" + person.fk_name_filial + "', '"+person.fk_id_user+"');")
    ...
    async update(request: Request, response: Response) {
        try {
            ...
            const  person : IPerson = <IPerson>request.body
            await client.query("UPDATE persons SET name_pers = '" + person.name_pers + "', cpf_pers = '" + person.cpf_pers + "', address_pers ='" + person.address_pers + "', fk_name_filial = '" + person.fk_name_filial + "' WHERE id_person = '" + id + "'")
